...
| Runtime / implementer and independent test/code reviewers | Approved runner design, frozen required fields above, TDD failure tests and full project gate. | Validators/scorer/excerpt checker exist; live runner, spend guard and trace integration do not. |
